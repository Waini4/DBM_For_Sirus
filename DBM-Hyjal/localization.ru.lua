...
L:SetMiscLocalization({
	...
	RageGossip       =
	"Леди Праудмур, мертвецы построили еще один лагерь. В скором времени они начнут атаковать нас. Мы готовы помочь!",
	...
	Boss1GossipStart =
	"Леди Праудмур, мы отразили натиск нежити, но разведчики докладывают о прибытии могущественного лича. Помогите нам!",
