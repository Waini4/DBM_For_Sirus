...
mod:RegisterEventsInCombat(
	...
	"SPELL_CAST_SUCCESS 62660 63276 63364 312978 312974"
)
mod:RegisterEvents(
...
local timerShadowCrashCD		= mod:NewCDTimer(9, 312978, nil, "Ranged", nil, 3)
local timerLifeLeech			= mod:NewTargetTimer(10, 312974, nil, false, 2, 3)
local timerLifeLeechCD			= mod:NewCDTimer(20.4, 312974, nil, nil, nil, 3)
