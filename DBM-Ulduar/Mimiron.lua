...
mod:RegisterEventsInCombat(
	...
	"UNIT_SPELLCAST_SUCCEEDED 34098 64402 65034"
)
...
local timerNextRockets		    = mod:NewNextTimer(20, 63041, nil, nil, nil, 3, nil, CL.DEADLY_ICON)
...
local timerNextDarkGlare		= mod:NewNextTimer(39, 63274, nil, nil, nil, 3, nil, CL.DEADLY_ICON) -- Лазерный обстрел P3Wx2
...
local timerShell				= mod:NewTargetTimer(6, 312788, nil, "Healer", 2, 5, nil, CL.HEALER_ICON)
...
local timerNextFrostBomb        = mod:NewNextTimer(30, 64623, nil, nil, nil, 3, nil, CL.HEROIC_ICON) --Ледяная бомба
