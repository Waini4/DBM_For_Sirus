...
-- do
	local function creategui()
		...
		DBM_GUI.SpellTimersMainTab = DBM_GUI:CreateNewPanel("Настройки индикаторов SpellTimers", "option")
		...
		TimersArea1.frame:SetScript("OnMouseUp", function()
			DBM:ShowUpdateReminder(nil, nil, LGUI.Area_BasicSetup, "https://github.com/DeadlyBossMods/DeadlyBossMods/wiki/%5BNew-User-Guide%5D-Initial-Setup-Tips")
		end)
		...
		TimersArea2.frame:SetScript("OnMouseUp", function()
			DBM:ShowUpdateReminder(nil, nil, LGUI.Area_ColorBytype, "https://github.com/DeadlyBossMods/DeadlyBossMods/wiki/%5BGuide%5D-Color-bars-by-type")
		end)
		...
		local testmebutton = BarSetup:CreateButton(LGUI.Button_TestBars, 100, 16)
		...
		local maindummybar = DBTST:CreateDummyBar(nil, nil, LGUI.SMALL)
		...
		local BarSetupSmall = BarSetupPanel:CreateArea(LGUI.AreaTitle_BarSetupSmall)

		local smalldummybar = DBTST:CreateDummyBar(nil, nil, LGUI.SMALL)
		...
		testmebutton = BarColors:CreateButton(LGUI.Button_TestBars, 100, 16)
		...
		color1Type1reset:SetScript("OnClick", function()
			color1Type1:SetColorRGB(DBTST.DefaultOptions.StartColorAR, DBTST.DefaultOptions.StartColorAG, DBTST.DefaultOptions.StartColorAB)
		end)
		color2Type1reset:SetScript("OnClick", function()
			color2Type1:SetColorRGB(DBTST.DefaultOptions.EndColorAR, DBTST.DefaultOptions.EndColorAG, DBTST.DefaultOptions.EndColorAB)
		end)
		...
		color1Type2reset:SetScript("OnClick", function()
			color1Type2:SetColorRGB(DBTST.DefaultOptions.StartColorAER, DBTST.DefaultOptions.StartColorAEG, DBTST.DefaultOptions.StartColorAEB)
		end)
		color2Type2reset:SetScript("OnClick", function()
			color2Type2:SetColorRGB(DBTST.DefaultOptions.EndColorAER, DBTST.DefaultOptions.EndColorAEG, DBTST.DefaultOptions.EndColorAEB)
		end)
		...
		color1Type3reset:SetScript("OnClick", function()
			color1Type3:SetColorRGB(DBTST.DefaultOptions.StartColorDR, DBTST.DefaultOptions.StartColorDG, DBTST.DefaultOptions.StartColorDB)
		end)
		color2Type3reset:SetScript("OnClick", function()
			color2Type3:SetColorRGB(DBTST.DefaultOptions.EndColorDR, DBTST.DefaultOptions.EndColorDG, DBTST.DefaultOptions.EndColorDB)
		end)
		...
		color1Type4reset:SetScript("OnClick", function()
			color1Type4:SetColorRGB(DBTST.DefaultOptions.StartColorIR, DBTST.DefaultOptions.StartColorIG, DBTST.DefaultOptions.StartColorIB)
		end)
		color2Type4reset:SetScript("OnClick", function()
			color2Type4:SetColorRGB(DBTST.DefaultOptions.EndColorIR, DBTST.DefaultOptions.EndColorIG, DBTST.DefaultOptions.EndColorIB)
		end)
		...
		color1Type5reset:SetScript("OnClick", function()
			color1Type5:SetColorRGB(DBTST.DefaultOptions.StartColorRR, DBTST.DefaultOptions.StartColorRG, DBTST.DefaultOptions.StartColorRB)
		end)
		color2Type5reset:SetScript("OnClick", function()
			color2Type5:SetColorRGB(DBTST.DefaultOptions.EndColorRR, DBTST.DefaultOptions.EndColorRG, DBTST.DefaultOptions.EndColorRB)
		end)
		...
		color1Type6reset:SetScript("OnClick", function()
			color1Type6:SetColorRGB(DBTST.DefaultOptions.StartColorPR, DBTST.DefaultOptions.StartColorPG, DBTST.DefaultOptions.StartColorPB)
		end)
		color2Type6reset:SetScript("OnClick", function()
			color2Type6:SetColorRGB(DBTST.DefaultOptions.EndColorPR, DBTST.DefaultOptions.EndColorPG, DBTST.DefaultOptions.EndColorPB)
		end)
		...
		color1Type7reset:SetScript("OnClick", function()
			color1Type7:SetColorRGB(DBTST.DefaultOptions.StartColorUIR, DBTST.DefaultOptions.StartColorUIG, DBTST.DefaultOptions.StartColorUIB)
		end)
		color2Type7reset:SetScript("OnClick", function()
			color2Type7:SetColorRGB(DBTST.DefaultOptions.EndColorUIR, DBTST.DefaultOptions.EndColorUIG, DBTST.DefaultOptions.EndColorUIB)
		end)
		...
		local forceLarge = BarColors:CreateCheckButton(LGUI.Bar7ForceLarge, false, nil, nil, "Bar7ForceLarge")
		forceLarge:SetPoint("TOPLEFT", bar7OptionsText, "BOTTOMLEFT")
		forceLarge:SetScript("OnClick", function(self)
			DBTST:SetOption("Bar7ForceLarge", not DBTST.Options.Bar7ForceLarge)
			if DBTST.Options.Bar7ForceLarge then
		...
		local customInline = BarColors:CreateCheckButton(LGUI.Bar7CustomInline, false, nil, nil, "Bar7CustomInline")
		customInline:SetPoint("TOPLEFT", forceLarge, "BOTTOMLEFT")
		customInline:SetScript("OnClick", function(self)
			DBTST:SetOption("Bar7CustomInline", not DBTST.Options.Bar7CustomInline)
		...
		local changeoptions = DBM_GUI.SpellTimersMainTab:CreateNewPanel("SpellTimersOptions", "option")
