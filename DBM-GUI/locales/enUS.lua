...
L.Website					= "Visit us on discord at |cFF73C2FBhttps://discord.gg/addonsforsirus|r"
...
L.UseAlternateRangeCheck    = "Use alternate range check if the standart doesn't work. |cffff1919WARNING!|r This option makes check less accurate, but working in every zone, e.g. Jaina in ICC25 Heroic."
