...
L.UseAlternateRangeCheck    = "Включить альтернативную проверку дистанции, если стандартная недоступна. |cffff1919ВНИМАНИЕ!|r Проверка менее точная, но работает в любых зонах, например на Джайне в ЦЛК 25 гер."
