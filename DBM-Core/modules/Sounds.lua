...
do
	local counts = {
		...
		{ text = "Аларак", value = "Alarak", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Alarak\\", max = 10 },
		{ text = "Тани", value = "Tani", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Tani\\", max = 10 },
		{ text = "Нади", value = "Nadi", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Nadi\\", max = 5 },
		{ text = "BlakbyrdAlert", value = "BlakbyrdAlerts", path = "Interface\\AddOns\\DBM-Core\\Sounds\\BlakbyrdAlerts\\",
			max = 3 },
	}
...
do
	local victory = {
		...
		{ text = "SMG: FF Fanfare", value = "Interface\\AddOns\\DBM-Core\\sounds\\Victory\\SmoothMcGroove_Fanfare.ogg",
			length = 4 },
		{ text = "VorazunGG", value = "Interface\\AddOns\\DBM-Core\\sounds\\Victory\\VorazunGG.ogg",
			length = 4 },
		{ text = "VorazunHistory", value = "Interface\\AddOns\\DBM-Core\\sounds\\Victory\\VorazunHistory.ogg",
			length = 4 },
		{ text = "AlarakRakshir", value = "Interface\\AddOns\\DBM-Core\\sounds\\Victory\\AlarakRakshir.ogg",
			length = 4 },
	}
	local hasCached = false
	local cachedTable
...
do
	local defeat = {
		{ text = CL.NONE, value = "None" },
		{ text = CL.RANDOM, value = "Random" },
		{ text = "Alizabal: Incompetent Raiders",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_BH_ALIZABAL_RESET_01.ogg", length = 4 },
		{ text = "Bwonsamdi: Over Your Head",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_801_Bwonsamdi_35_M.ogg", length = 4 },
		{ text = "Bwonsamdi: Pour Little Thing",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_801_Bwonsamdi_37_M.ogg", length = 4 },
		{ text = "Bwonsamdi: Impressive Death",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_801_Bwonsamdi_38_M.ogg", length = 4 },
		{ text = "Bwonsamdi: All That Armor",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_801_Bwonsamdi_50_M.ogg", length = 4 },
		...
		{ text = "Scrollsage Nola: Cycle",
			value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\VO_801_Scrollsage_Nola_34_F.ogg", length = 4 },
...
do
	...
	local dungeonMusic = {
		{ text = CL.NONE, value = "None" },
		{ text = CL.RANDOM, value = "Random" },
		{ text = "Anduin Part 1 B", value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\MUS_70_AnduinPt1_B.mp3",
			length = 140 }, -- Soundkit: 68230
		{ text = "Nightsong", value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\MUS_NightElves_GU01.mp3",
			length = 160 }, -- Soundkit: 71181
		{ text = "Ulduar: Titan Orchestra", value = "Sound\\Music\\ZoneMusic\\UlduarRaidInt\\UR_TitanOrchestraIntro.mp3",
			length = 102 }, -- Soundkit: 15873
	}
...
do
	...
	local battleMusic = {
		{ text = CL.NONE, value = "None" },
		{ text = CL.RANDOM, value = "Random" },
		{ text = "Anduin Part 2 B", value = "Interface\\AddOns\\DBM-Core\\sounds\\RetailSupport\\MUS_70_AnduinPt2_B.mp3",
			length = 111 }, -- Soundkit: 68230
