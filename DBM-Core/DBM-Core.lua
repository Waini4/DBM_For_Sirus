...
DBM = {
	...
	ReleaseRevision = releaseDate(2025, 05, 07, 22, 00, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
