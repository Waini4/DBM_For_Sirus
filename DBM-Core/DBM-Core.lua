...
DBM = {
	Revision = parseCurseDate("20220720194100"),
	DisplayVersion = "9.2.01", -- the string that is shown as version
	ReleaseRevision = releaseDate(2022, 7, 20, 19, 41, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
