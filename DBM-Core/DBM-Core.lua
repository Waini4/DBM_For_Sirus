...
DBM = {
	Revision = parseCurseDate("2024" .. "03" .. "28" .. "08" .. "00" .. "00"),
	DisplayVersion = GetAddOnMetadata(_addonname, "Version"), -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 03, 28, 08, 00, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
