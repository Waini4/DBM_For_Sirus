...
DBM = {
	Revision = parseCurseDate("2023" .. "05" .. "12" .. "00" .. "00" .. "00"),
	DisplayVersion = GetAddOnMetadata(_addonname, "Version"), -- the string that is shown as version
	ReleaseRevision = releaseDate(2023, 05, 12, 00, 00, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
...
do
	...
	function DBM:DemoMode()
		...
		testTimer3:Stop("Плохой дебаф")
		testTimer4:Stop("Important Interrupt")
		testTimer5:Stop("БУУМ!")
		...
		testWarning1:Schedule(62, "Тест-мод завершен!")
		testWarning3:Schedule(50, "Взрыв через 10 сек!")
		testWarning3:Schedule(20, "Пиу Пиу Лазерная Сова!")
		testWarning2:Schedule(38, "Плохой Спелл через 5 сек!")
		testWarning2:Schedule(43, "Плохой Спелл!")
		testWarning1:Schedule(10, "Тест Бар истекает!")
		testSpecialWarning1:Schedule(20, "Пиу Пиу Лазерная Сова")
		...
		testSpecialWarning3:Schedule(60, "БУУМ!")
