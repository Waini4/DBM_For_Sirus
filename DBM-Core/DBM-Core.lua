...
DBM = {
	...
	ReleaseRevision = releaseDate(2022, 7, 26, 15, 00, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
