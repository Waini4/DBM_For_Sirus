...
L:SetWarningLocalization({
	...
	WarnVengefulShade           = "Мстительный дух на %s",
...
L:SetOptionLocalization({
	...
	AnnounceVengefulShadeTargets    = "Анонсировать цели духов (неточно)",
})
...
L:SetOptionLocalization({
	...
	SetIconOnExplosiveTargets	= DBML.AUTO_ICONS_OPTION_TARGETS:format(306487),
